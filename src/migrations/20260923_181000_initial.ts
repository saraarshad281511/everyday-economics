...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "_posts_v" (
  	...
  	"version_is_opinion" boolean DEFAULT false,
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"site_name" varchar DEFAULT 'The Everyday Economics' NOT NULL,
  	"tagline" varchar DEFAULT 'Money, markets and the economy, explained for everyone',
  	"newsletter_heading" varchar DEFAULT 'The Weekly Ledger',
  	"newsletter_text" varchar DEFAULT 'One email every Sunday: the week’s biggest economic stories, in plain English.',
  	"social_x" varchar,
