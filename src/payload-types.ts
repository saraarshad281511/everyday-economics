...
export interface Post {
  ...
  /**
   * Optional. Title for Google & social media (defaults to the headline).
   */
  metaTitle?: string | null;
  /**
   * Optional. Defaults to the standfirst.
   */
  ...
  /**
   * Show as the big story at the top of the homepage (the newest one wins).
   */
  featured?: boolean | null;
  /**
   * Adds an "Opinion" label and author photo.
   */
...
export interface Media {
  id: number;
  /**
   * Describe the image for screen readers and Google.
   */
  alt: string;
  caption?: string | null;
  /**
   * e.g. "Reuters" or "Photo: Sara A."
   */
  credit?: string | null;
  prefix?: string | null;
